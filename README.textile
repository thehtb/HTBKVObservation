h1. HTBKVObservation - Yet Another KVO-improvement project

h2. Synopsis

p. Include HTBKVObservation.m and .h in your project

bc.. #import "HTBKVObservation.h"
...
h2. Observation/Binding Lifetime
...
# The HTBKVObservation object is dealloc'd
# The observed object is dealloc'd
# The HTBKVObservation object is sent an invalidate message.
...
* v0.3 : Fixed a possible race condition.
* v0.4 : Added uni-directional binding.
